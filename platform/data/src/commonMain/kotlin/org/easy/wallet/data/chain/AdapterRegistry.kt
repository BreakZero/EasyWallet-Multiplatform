...
class AdapterRegistry(
     ...
     */
    fun getAllAdapters(): List<IChainAdapter> {
     ...
     */
    fun getAdaptersByStandard(standard: TokenStandard): List<IChainAdapter> {
     ...
     */
    fun getSupportedChains(): Set<ChainId> {
        return adapters.keys.map { ChainId(it) }.toSet()
    }

    /**
     * Check if a chain is supported.
     */
    fun isChainSupported(chainId: ChainId): Boolean {
        return chainId.value in adapters
    }

    /**
     * Get adapter by ChainId, returning null if not found.
     */
    fun getAdapterOrNull(chainId: ChainId): IChainAdapter? {
        return adapters[chainId.value]
    }
}
