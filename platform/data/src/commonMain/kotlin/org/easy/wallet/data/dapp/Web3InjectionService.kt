...
class Web3InjectionService(
   ...
   */
  fun getProviderForChain(chainId: ChainId): Web3Provider = createProvider(chainId)
   ...
   */
  suspend fun handleTransactionRequest(request: TransactionRequest, coinType: CoinType): TransactionRequestResult {
   ...
   */
  suspend fun switchChain(chainId: ChainId): SwitchChainResult = try {
  ...
  private fun createProvider(chainId: ChainId): Web3Provider = when {
